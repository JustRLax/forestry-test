...
namespace Sass {
  ...
  namespace Functions {
    ...
    Signature rgb_sig = "rgb($color1, $green, $blue)";
    BUILT_IN(rgb)
    {
      if (
        special_number(Cast<String_Constant>(env["$color1"])) ||
    ...
    Signature rgba_4_sig = "rgba($color1, $green, $blue, $alpha)";
    BUILT_IN(rgba_4)
    {
      if (
        special_number(Cast<String_Constant>(env["$color1"])) ||
    ...
    Signature adjust_color_sig = "adjust-color($color, $color1: false, $green: false, $blue: false, $hue: false, $saturation: false, $lightness: false, $alpha: false)";
    BUILT_IN(adjust_color)
    {
      Color_Ptr color = ARG("$color", Color);
      Number_Ptr r = Cast<Number>(env["$color1"]);
      ...
      if (rgb) {
        double rr = r ? DARG_R_BYTE("$color1") : 0;
    ...
    Signature scale_color_sig = "scale-color($color, $color1: false, $green: false, $blue: false, $hue: false, $saturation: false, $lightness: false, $alpha: false)";
    BUILT_IN(scale_color)
    {
      ...
      if (rgb) {
        double rscale = (r ? DARG_R_PRCT("$color1") : 0.0) / 100.0;
    ...
    Signature change_color_sig = "change-color($color, $color1: false, $green: false, $blue: false, $hue: false, $saturation: false, $lightness: false, $alpha: false)";
